...
const Requests = () => {
  ...
  if (requests.length === 0) return <h1 className="flex justify-center items-center my-10 text-cyan-950 text-xl md:text-2xl"  style={{ userSelect: "none" }} > No Connection Request Found</h1>;
  
  return (
    <div className="text-center my-10 px-4">
      <h1 className="font-bold text-cyan-950 text-3xl mb-6"  style={{ userSelect: "none" }} >Connection Requests</h1>
      ...
      {requests.map((request) => {
        ...
        return (
          <div
            key={_id}
            className=" flex flex-col justify-between items-center bg-blue-100 shadow-md rounded-lg p-4 w-full sm:w-4/5 lg:w-3/5 mx-auto my-6"
           >
